...
import dtourImage from "../assets/images/pawmatch.png";
import dtour1 from "../assets/images/pawmatch1.png";
import dtour2 from "../assets/images/pawmatch2.png";
      ...
      <div className="bg-black text-white min-h-screen">
        ...
        <div className="max-w-4xl mx-auto py-8 px-4">
          ...
          <p className="text-lg text-gray-300">
            A Pet Adoption Platform designed to connect loving homes with furry
            friends in need. This project showcases my skills in crafting
            user-friendly, responsive interfaces using React. With seamless
            navigation, dynamic pet profiles, and intuitive search features, Paw
            Match is built to make finding your perfect companion as easy and
            heartwarming as possible.
          </p>
          <br />
          ...
          <div className="flex flex-col mt-10 md:flex-row justify-around my-8">
            <div
              onClick={() =>
                window.open("https://github.com/devdavix2/pawmatch", "_blank")
              }
            ...
            <div
              onClick={() =>
                window.open("https://pawmatch-sigma.vercel.app/", "_blank")
              }
